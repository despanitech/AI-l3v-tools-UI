...
export default function App() {
  ...
  return <InvitationGate><a className="skip" href="#workspace">Skip to tool</a><header className="topbar"><a className="brand" href="#home" aria-label="l3v AI tools home"><img src="/assets/l3v-mark.png" alt="" width="54" height="36" /><span>AI tools</span></a><nav aria-label="Tools"><a href="#home" id="nav-home" aria-current={tool === 'home' ? 'page' : undefined}>All tools</a><a href="#logo" id="nav-logo" aria-current={identity ? 'page' : undefined}>Magic Identity</a><a href="#video" id="nav-video" aria-current={tool === 'video' ? 'page' : undefined}>AI Video Suggestion</a><a href="#assets" aria-current={['assets','work'].includes(tool) ? 'page' : undefined}>My assets</a></nav><DirectorPromo variant="header"/><Appearance /></header><MenuFontPicker /><main id="workspace" tabIndex={-1}><Home hidden={tool !== 'home'} /><Video hidden={tool !== 'video'} /><MyWork hidden={!['assets','work'].includes(tool)} /><Identity tool={tool} localPreview={localPreview} /></main><DirectorPromo variant="footer"/><SupportProject variant="footer" /><footer><span>l3v AI tools</span><span>A little less friction. A little more creating.</span></footer></InvitationGate>;
}
