...
export default function Home({hidden}) {
  return <section id="home-panel" aria-labelledby="home-title" hidden={hidden}>
    ...
    </div><p className="landing-note">A growing collection. AI generation is being connected; available previews are ready to explore.</p><SupportProject variant="home" />
  </section>;
}
