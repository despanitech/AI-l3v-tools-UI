...
const examples = {
  ...
  initials: {file: 'magic-initials.png', alt: 'E and H — Airy Ribbon initials example'},
  signature: {file: 'magic-signature.png', alt: 'E. Hart — Bold Autograph signature example'},
};
...
export default function Identity({tool, localPreview}) {
  ...
  return <section id="logo-panel" aria-label="Magic Identity" hidden={!visible}>
    ...
    <div className="name-workspace" hidden={showResults}><p className="eyebrow">YOUR NAME, THREE DIRECTIONS</p><h1>Make it your own.</h1>
      ...
      <NameLogoGenerator first={first} last={last} visible={visible && direction === 'name' && !showResults} />
    </div>
