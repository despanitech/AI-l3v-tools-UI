...
export function createRequest(first,last,styleId){const access={requestId:random(16),receipt:random(32)};const value={access,requestKey:access.requestId,first:first.trim(),last:last.trim(),...(Array.isArray(styleId)?{styles:styleId}:{styleId})};remember(value);return value;}
